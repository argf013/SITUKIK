...
const PatroliPage = {
  ...
  async afterRender() {
    ...
    const addSarang = async () => {
      ...
      const perkiraanTglPeneluran = document.getElementById(
        'perkiraanTglPeneluran',
      ).value;
      const inputKetebalanPenutup = document.getElementById(
        'inputKetebalanPenutup',
      ).value;
      const inputKedalamanDasar = document.getElementById(
        'inputKedalamanDasar',
      ).value;
      const inputJumlahTelur = Number(
        document.getElementById('inputJumlahTelur').value,
      );
      const inputJenisPenyu01 = document.getElementById('inputJenisPenyu01').value;
      const inputTelurBaik = Number(
        document.getElementById('inputTelurBaik').value,
      );
      const inputTelurRusak = Number(
        document.getElementById('inputTelurRusak').value,
      );
      const inputTelurMati = Number(
        document.getElementById('inputTelurMati').value,
      );
      const inputTelurAbnormal = Number(
        document.getElementById('inputTelurAbnormal').value,
      );
      ...
      if (
        ...
        jumlahTelurGagal = Number(inputTelurAbnormal)
          + Number(inputTelurMati)
          + Number(inputTelurRusak);
        const newPatroli = {
          tglPenemuan,
          waktuDitemukan,
          tglPeneluran,
    ...
    const updateSarang = async (id) => {
      ...
      const updatewaktuDitemukan = document.getElementById(
        'update-waktuDitemukan',
      );
      const updatetglPeneluran = document.getElementById('update-tglPeneluran');
      const updateperkiraanTglPeneluran = document.getElementById(
        'update-perkiraanTglPeneluran',
      );
      const updateKetebalanPenutup = document.getElementById(
        'update-KetebalanPenutup',
      );
      const updateKedalamanDasar = document.getElementById(
        'update-KedalamanDasar',
      );
      ...
      const updateTelurAbnormal = document.getElementById(
        'update-TelurAbnormal',
      );
