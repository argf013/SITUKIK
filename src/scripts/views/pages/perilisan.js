...
const PerilisanPage = {
  async render() {
    return `
      <div class="content">
        ...
        <nav aria-label="Page navigation example" class="ms-5">
          <ul class="pagination flex-wrap">
            <li class="page-item">
              <a class="page-link rounded-0" href="#/patroli">Patroli</a>
            </li>
            <li class="page-item">
              <a class="page-link" href="#/inkubasi">Inkubasi</a>
            </li>
            <li class="page-item">
              <a class="page-link" href="#/penangkaran">Penangkaran</a>
            </li>
            <li class="page-item">
              <a class="page-link rounded-0 active" href="#/perilisan"
                >Perilisan</a
              >
            </li>
          </ul>
      ...
      <div
        ...
        id="ubahRilisModal"
        tabindex="-1"
        aria-labelledby="ubahRilisModalLabel"
        aria-hidden="true"
      >
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p class="text-center pb-2">
                Isikan data berikut ketika ingin mengubah data perilisan tukik
              </p>
              ...
              <form>
                <div class="container my-3">
                  <div class="row row-cols-2">
                    <div class="col">
                      <div class="mb-3">
                        <label for="exampleInputDate" class="form-label"
                          >Tanggal Perilisan</label
                        >
                        <input
                          type="date"
                          class="form-control"
                          id="update-tglPerilisan"
                    ...
                    <div class="col">
                      <div class="mb-3">
                        <label for="exampleInputDate" class="form-label"
                          >Waktu Perilisan</label
                        >
                        <input
                          type="time"
                          class="form-control"
                          id="update-waktuPerilisan"
                          aria-describedby="dateHelp"
                        />
                      </div>
                    </div>
                    <div class="col">
                      <div class="mb-3">
                        <label for="exampleInputWeather" class="form-la bel"
                          >Cuaca</label
                        >
                ...
                <div class="container my-3">
                  <div class="row row-cols-2">
                    <div class="col">
                      <div class="mb-3">
                        <label for="inputJenisPenyu" class="form-label"
                          >Jenis Penyu</label
                        >
                        <div class="input-group mb-3">
                    ...
                    <div class="col">
                      <div class="mb-3">
                        <label for="jumlahTukikRilis" class="form-label"
                          >Jumlah Tukik
                        </label>
                        <input
                          type="number"
                          class="form-control"
                          id="update-jumlahTukikRilis"
                          aria-describedby="dateHelp"
                          placeholder="ekor"
                        />
                      </div>
            ...
            <div class="modal-footer mx-auto">
              ...
              <button
                type="button"
                class="btn filled-button updateBtn"
                data-bs-dismiss="modal"
              >
                Update
              </button>
  ...
  async afterRender() {
    ...
    const updateRilis = async (id) => {
      ...
      const updatewaktuPerilisan = document.getElementById(
        'update-waktuPerilisan',
      );
      const updateCuaca = document.getElementById('update-cuaca');
      const updatejenisPenyu = document.getElementById('update-JenisPenyu');
      const updatejumlahTukikRilis = document.getElementById(
        'update-jumlahTukikRilis',
      );
      ...
      querySnapshot.forEach((item) => {
        ...
        sarangElement.innerHTML += `
          ...
          <td class="text-center">
            <button type="button" class="btn btn-warning px-2 rounded-4 update-btn" data-bs-toggle="modal" data-bs-target="#ubahRilisModal" title="Ubah Data" id=${
  item.id
}><i class="bi bi-pencil-square action-btn"></i></button>
            <button type="button" class="btn btn-danger px-2 rounded-4 delete-btn" title="Hapus Data" id=${
  item.id
